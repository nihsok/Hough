...
Current setting
- Wave form: $e^{i(s\phi+\sigma t)}$
- Zonal wavenumber: s>0, integer
  - s<0 is not yet implemented
- Frequency: $\sigma>0$
  - Phase speed = $-\sigma/s$
- Latitudinal interval: 1 degree (fixed)
- Truncation order: 100 (under consideration)
- Treatment at singularity ($\sigma$<1): Interpolation

# English documentation
See [Wang et al. (2016)](https://doi.org/10.5194/gmd-9-1477-2016).
[Groves (1981)](https://doi.org/10.1016/0032-0633(81)90100-8) is also helpful.
...
この方法では周波数を固定して対応する等価深度を求めているが、等価深度を与えて周波数を計算する方法も考えることができる。